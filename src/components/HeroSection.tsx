...
const HeroSection = () => {
  return (
    <section className="relative min-h-screen bg-gradient-subtle overflow-hidden">
      ...
      <div className="absolute bottom-10 right-10 w-96 h-96 bg-brain-glow/10 rounded-full blur-3xl"></div>
      
      <div className="relative container mx-auto px-6 py-20">
        {/* Beta Badge */}
        <div className="flex justify-center mb-8">
          <Badge variant="secondary" className="px-6 py-2 text-sm font-medium shadow-card animate-pulse">
        ...
        <div className="text-center max-w-4xl mx-auto mb-16 mt-32">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16">
            <Button 
              size="lg" 
              className="bg-gradient-hero hover:shadow-intense transition-all duration-500 text-lg px-8 py-4 rounded-full font-semibold"
            >
            ...
            <Button 
              variant="outline" 
              size="lg" 
              className="text-lg px-8 py-4 rounded-full border-2 hover:shadow-glow transition-all duration-300"
            >
              Ver Demo en Vivo
            </Button>
          </div>
        ...
        <div className="max-w-2xl mx-auto mb-16">
          <Card className="p-8 bg-gradient-card shadow-card border-0 hover:shadow-intense transition-all duration-500">
            <div className="text-center">
              <div className="flex items-center justify-center mb-4">
                <Brain className="w-8 h-8 text-brain-glow mr-3 animate-pulse" />
                <span className="text-3xl font-bold text-brain-glow mr-2">2,847</span>
              ...
              <div className="flex items-center justify-center text-lg text-muted-foreground">
                <TrendingUp className="w-5 h-5 text-success-glow mr-2" />
                <span>generando </span>
                <span className="font-bold text-success-glow mx-1">$127K MRR</span>
                <span> colectivo</span>
              </div>
            </div>
          </Card>
        ...
        <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
          <Card className="p-6 bg-gradient-card shadow-card border-0 hover:shadow-glow transition-all duration-300 text-center">
        ...
        <div className="mt-16 text-center">
          <div className="inline-flex items-center bg-warning-glow/10 border border-warning-glow/20 rounded-full px-6 py-3">
            <Clock className="w-5 h-5 text-warning-glow mr-2 animate-pulse" />
            <span className="text-warning-glow font-medium">
